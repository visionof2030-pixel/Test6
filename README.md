...
.auto-buttons button{
width:100%;margin-top:5px;padding:6px;background:none;border:2px solid #066d4d;color:#066d4d;
...
.info-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:4px;margin-top:10px;}
.info-grid2{display:grid;grid-template-columns:repeat(3,1fr);gap:4px;margin-bottom:8px;margin-top:10px;}

.info-box{
background:#e8f2ee;border-radius:6px;height:34px;display:flex;flex-direction:column;
justify-content:center;align-items:center;border:1px solid rgba(6,109,77,0.3);
}
...
.objective-content{font-size:13px;line-height:1.6;overflow:hidden;text-overflow:ellipsis;}
...
.report-box-content{font-size:13px;line-height:1.6;overflow:hidden;text-overflow:ellipsis;}
...
<div class="header-date-box"><span id="hDate"></span><br><span id="gDate"></span></div>
</div>
...
"توفير بيئة تعليمية تفاعلية تدعم الإبداع وتطوير المهارات المعرفية والاجتماعية والسلوكية لدى الطلاب وتحفيزهم للمشاركة الفعّالة وتنمية قدراتهم على حل المشكلات واتخاذ القرارات المناسبة في مواقف التعلم المتنوعة."
],
summary:[
...
"ساعد النشاط في تعزيز التعلم النشط وتحسين التفاعل داخل الصف وخلق بيئة تعليمية محفزة تحقق أهداف الدرس وتلبي احتياجات الطلاب المتنوعة."
],
steps:[
...
"تطبيق استراتيجيات فعّالة داخل الصف مع إدارة الوقت بشكل جيد وتوزيع الأدوار بين الطلاب لضمان مشاركة الجميع وتحقيق نتائج تعليمية واضحة وملموسة.",
...
strategies:[
"التعلم التعاوني وتبادل الأدوار بين الطلاب لتفعيل المشاركة وتحسين مستوى التعاون ومهارات التواصل بين أفراد المجموعة بصورة فعالة.",
"العصف الذهني وتنشيط التفكير الإبداعي لدى الطلاب وتشجيعهم على طرح الأفكار والحلول وتبادل وجهات النظر داخل المجموعة.",
"المناقشة الصفية وطرح الأسئلة التحفيزية ودعم التفكير النقدي لتعزيز الفهم العميق للمفاهيم المقدمة خلال الدرس بطريقة جميلة.",
"استخدام التعلم النشط وتوظيف الوسائط المتعددة لجذب انتباه الطلاب وزيادة تركيزهم خلال مراحل النشاط المختلفة.",
"توظيف التعليم التعاوني والعروض التقديمية القصيرة لتحسين مهارات التعبير والاتصال وبناء الثقة لدى الطلاب."
],
strengths:[
"تفاعل ممتاز من الطلاب أثناء النشاط وظهور مهارات تواصل قوية بينهم مع تطبيق الاستراتيجيات التعليمية بفعالية كبيرة.",
"إقبال رائع على المشاركة واهتمام واضح بتحقيق أهداف الدرس مما انعكس على جودة العمل الجماعي داخل الصف.",
"مستوى جيد من التنظيم داخل الصف وتعاون كبير بين الطلاب مما أسهم في نجاح النشاط بشكل ملحوظ.",
"تحسن واضح في الفهم لدى الطلاب وقدرة أكبر على تطبيق المفاهيم المكتسبة خلال النشاط التعليمي.",
"انضباط ممتاز خلال النشاط ودافعية واضحة لدى الطلاب لتحقيق التميز وإظهار أفضل ما لديهم."
],
improve:[
"زيادة التركيز على دعم الطلاب المتعثرين وتوفير فرص تعلم إضافية لهم بما يلبي احتياجاتهم التعليمية بأسلوب مناسب.",
"العمل على تعزيز مهارات القراءة والكتابة لدى بعض الطلاب لضمان استفادتهم القصوى من النشاط التعليمي.",
"التوسع في استخدام وسائل تعليمية وتطبيقات تقنية تزيد من مستوى التفاعل داخل الصف بطرق مبتكرة.",
"تحسين إدارة الوقت أثناء تنفيذ الأنشطة للتأكد من إكمال جميع مراحل النشاط المخطط لها بالشكل الأمثل.",
"تقديم مزيد من المتابعة الفردية للطلاب الأقل تفاعلاً لضمان مشاركتهم وتحسين أدائهم المستقبلي."
],
recomm:[
"الاستمرار في تطبيق الأنشطة التفاعلية داخل الصف وتوظيف التكنولوجيا بطرق داعمة للطلاب ومحققة للأهداف التعليمية.",
"توفير دورات تدريبية قصيرة للطلاب لتعزيز مهارات التفكير والتحليل والتواصل وتحسين الأداء المستقبلي.",
"تنويع الاستراتيجيات المستخدمة في التعليم وتوفير فرص أكثر للتعلم التعاوني بين الطلاب خلال العام الدراسي.",
"توسيع نطاق الأنشطة الصفية وربطها بحياة الطلاب اليومية لتصبح أكثر فاعلية وتأثيرًا على تعلمهم وسلوكهم.",
"تشجيع الطلاب على المبادرة والمشاركة المستمرة وتحفيزهم من خلال تقديم مكافآت بسيطة تعزز روح الإبداع لديهم."
]
};
...
}).from(document.getElementById("report-content")).save().then(()=>{
